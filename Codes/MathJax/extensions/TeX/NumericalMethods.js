MathJax.Hub.Config({
	TeX: {
		Macros: {
			...
			rk2: ["{u_{k+1} = {#2} + {#3}[{#4}f'({#1}, {#2}) + {#5}f'({#1} + {#6}{#3}, {#2} + {#6}{#3}}f'({#1}, {#2}))]}", 6],
			rk4: ["{\\begin{split}k_{1} &= {#3}f'({#1}, {#2}) \\\\\\ k_{2} &= {#3}f'({#1} + \frac{{#3}}{2}, {#2} + \frac{k_{1}}{2}) \\\\\\ k_{3} &= {#3}f'({#1} + \frac{{#3}}{2}, {#2} + \frac{k_{2}}{2}) \\\\\\ k_{4} &= {#3}f'({#1} + {#3}, {#2} + k_{3}) \\\\\\ u_{k+1} &= {#2} + \frac{1}{6}(k_{1} + 2k_{2} + 2k_{3} + k_{4})\\end{split}}", 3],
